    ...
    CommandLineRunner initData(
        ...
        return new CommandLineRunner() {
            ...
            public void run(String... args) throws Exception {
                ...
                Member memberUser9ByFacebook = memberService.whenSocialLogin("FACEBOOK", "FACEBOOK__2605018686313698").getData();
                ...
                LikeablePerson likeablePersonToSsuehee = likeablePersonService.like(memberUser5, "ssuehee", 1).getData();
                LikeablePerson likeablePersonToSsuehee2 = likeablePersonService.like(memberUser4, "ssuehee", 1).getData();
            }
        };
    }
}
